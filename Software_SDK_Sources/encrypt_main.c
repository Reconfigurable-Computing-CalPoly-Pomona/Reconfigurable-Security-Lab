...
//				currentChunk = currentChunk | (receiveBuffer[])
			...
			AXI_ENCRYPT_PERIPHERAL_FINAL_mWriteReg(XPAR_AXI_ENCRYPT_PERIPHER_0_BASEADDR, ((x*16)+(12-(4*i))), currentChunk);
...
//			writtenChunk = AXI_ENCRYPT_PERIPHERAL_FINAL_mReadReg(XPAR_AXI_ENCRYPT_PERIPHER_0_BASEADDR,((inputTypes[x]*16)+(4*i)));
	...
	{
		currentChunk = AXI_ENCRYPT_PERIPHERAL_FINAL_mReadReg(XPAR_AXI_ENCRYPT_PERIPHER_0_BASEADDR,((inputTypes[i]*16)));
	}
